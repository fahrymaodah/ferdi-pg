                        ...
                        <div class="flex-1 mt-6 xl:mt-0">
                            <div class="grid grid-cols-12 gap-x-5 mt-3">
                                <div class="col-span-12 2xl:col-span-4">
                                    ...
                                    <input id="product-code" type="text" class="form-control" name="product_code" placeholder="Product Code" value="<?php echo set_value('product_code') ?>">
                                ...
                                <div class="col-span-12 2xl:col-span-8">
                                    ...
                                    <input id="product-name" type="text" class="form-control" name="product_name" placeholder="Product Name" value="<?php echo set_value('product_name') ?>">
                            ...
                            <div class="grid grid-cols-12 gap-x-5 mt-3">
                                ...
                                <div class="col-span-12 2xl:col-span-4">
                                    ...
                                    <input id="product-price" type="text" class="form-control" name="product_price" placeholder="Product Price" value="<?php echo set_value('product_price') ?>">
                                    <div class="text-danger small ml-2 mt-1"><?php echo form_error('product_price') ?></div>
                                </div>
                                <div class="col-span-12 2xl:col-span-4">
                                    <label for="product-image" class="form-label ml-2">Product Image</label>
                            ...
                            <div class="grid grid-cols-12 gap-x-5 mt-3">
                                <div class="col-span-12 2xl:col-span-12">
                                    ...
                                    <textarea id="product-description" class="form-control" name="product_description" placeholder="Product Description"><?php echo set_value('product_description') ?></textarea>
