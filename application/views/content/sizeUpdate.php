            ...
            <div class="p-5">
                <form method="post">
                    <div class="mt-3">
                        ...
                        <select id="categori-id" class="form-control" name="category_id">
                            ...
                            <?php foreach ($category as $key => $value): ?>
                                <option value="<?php echo $value['category_id'] ?>" <?php echo $size['category_id'] == $value['category_id'] ? 'selected="selected"' : '' ?>>
                    ...
                    <div class="mt-3">
                        ...
                        <input id="size-name" type="text" class="form-control" name="size_name" placeholder="Size Name" value="<?php echo $size['size_name'] ?>">
                    ...
                    <div class="mt-3">
                        ...
                        <input id="size-description" type="text" class="form-control" name="size_description" placeholder="Size Description" value="<?php echo $size['size_description'] ?>">
                        <div class="text-danger small ml-2 mt-1"><?php echo form_error('size_name') ?></div>
                    </div>
