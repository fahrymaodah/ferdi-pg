<h2 class="text-lg font-medium mr-auto mt-8">
    <?php echo $category['category_name'] ?> Category
</h2>
...
<?php else: ?>
    <div class="intro-y col-span-11 alert alert-primary alert-dismissible show flex items-center my-3" role="alert">
        <i data-lucide="info" class="mr-2"></i>
        <span>Produk tidak tersedia pada Kategori <b><?php echo $category['category_name'] ?></b></span>
