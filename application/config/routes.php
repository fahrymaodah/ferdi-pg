...
$route['admin']					= 'admin/account/index';
$route['admin/password']		= 'admin/account/password';
$route['admin/profile']			= 'admin/account/profile';
$route['admin/register']		= 'admin/account/register';
...
$route['category/([a-z-]+)']	= 'category/index/$1';